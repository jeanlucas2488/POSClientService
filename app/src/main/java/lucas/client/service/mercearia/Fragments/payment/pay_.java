...
public class pay_ extends AppCompatActivity
{
    SQLiteControl db;
    Context c = this;
    AlertDialog dis;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        tipo.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View p1)
            {
                ...
                AlertDialog.Builder sel = new AlertDialog.Builder(pay_.this, AlertDialog.THEME_DEVICE_DEFAULT_DARK);
